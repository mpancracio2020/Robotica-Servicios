              ...
              {accordionData.map(({ title, content }) => (
                <Accordion title={'More content..'} 
                  ...
                  <pre>
                    ...
                    <center><iframe width="560" height="315" src="https://www.youtube.com/embed/-4JbaEKZh1k?si=LXlScXNauN7jRCte" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe> 
                    </center>
                  <span></span>
              ...
              {accordionData.map(({ title, content }) => (
                <Accordion title={'More content..'} 
                  ...
                  To do this we will use an image of the map, and it will return in pixels a path with the movement to follow to lift and transport the shelf.
                    ...
                    <center>
                      <img src={angulosp4} width={350} height={170} alt='Large Pizza' />
                    </center>
